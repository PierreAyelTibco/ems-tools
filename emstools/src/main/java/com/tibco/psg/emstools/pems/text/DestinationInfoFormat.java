...
public class DestinationInfoFormat {
	...
	public static String toCSV(DestinationInfo p_entry, String p_timestamp) {
		if (null==p_entry)
			return (p_timestamp!=null? p_timestamp:"")+"";
		
		StatData in = p_entry.getInboundStatistics();
		StatData out = p_entry.getOutboundStatistics();
	 ...
	 */
	public static void printCSV(DestinationInfo p_entries[], boolean p_header, boolean p_timestamp) {
		if (true==p_header)
